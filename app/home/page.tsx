...
const Dashboard = () => {
  ...
  return (
    <div style={{
      ...
      backgroundImage: `
        linear-gradient(#05050508 2px, transparent 2px),
        linear-gradient(90deg, #05050508 2px, transparent 2px)
      `,
      ...
      <div style={{
        ...
        <div className="brutal-shadow" style={{
          ...
          {dreams.map((dream, i) => (
            <div key={i} style={{ marginBottom: i === dreams.length - 1 ? '0' : '10px' }}>
              ...
              <div style={{ background: '#050505', height: '8px', border: '2px solid #050505' }}>
                <div style={{
                  background: '#FFFFFF',
                  height: '100%',
        ...
        <div className="brutal-shadow" style={{
          ...
          {transactions.map((txn, i) => (
            <div key={i} style={{
              background: txn.amount > 0 ? '#FFFFFF' : '#CCFF00',
              border: '2px solid #050505',
              padding: '12px',
        ...
        <div className="brutal-shadow" style={{
          ...
          <div style={{ display: 'flex', gap: '10px', flex: 1 }}>
            {portfolio.map((item, i) => (
              <div key={i} style={{
                flex: 1,
                background: item.returns > 0 ? '#CCFF00' : '#FFFFFF',
                border: '2px solid #050505',
                padding: '14px',
                display: 'flex',
                flexDirection: 'column',
